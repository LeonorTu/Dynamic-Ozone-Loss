# -*- coding: utf-8 -*-
"""
Created on Fri Jun  4 09:54:08 2021
...
lons=O3.lon.data 
a=O3['o3'].loc['1979-01-15':'2014-12-15',20000.:,0.:,:]  #选取1979-2014共35年 200hpa- 北半球的O3数据
...
XX,YY=np.meshgrid(lons[:144],lats,indexing='ij')
ca=ax.contourf(XX,YY,(a12[:,:144]).T*(1e+8),levels=np.arange(-14,14.1,1),cmap=plt.cm.RdBu_r)
